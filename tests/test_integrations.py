...
import fofamap
from core.integrations import HOSTS, IntegrationError, integrate_host, normalize_host, supported_hosts
...
def test_json_merge_preserves_unrelated_servers_and_uninstall_removes_only_fofamap(tmp_path: Path):
    ...
    assert installed["mcpServers"]["fofamap"] == {"command": "fofamap-mcp", "args": []}
